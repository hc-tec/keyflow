...
function makeWorkspaceReadme({ kitId, name }) {
  return [
    ...
    "```",
    "",
    "默认不传 `--scope` 时，npm 包名会自动生成为 `keyflow-kit-<kitId>`。",
    "如果你已经有 npm 组织，后面再改成 `--scope myorg` 或 `--package-name @myorg/my-proofreader` 即可。",
    "",
    "官方 catalog 提交前必须先真实发布 npm 包，并确认 `npm view <package>@<version>` 和 `npm run catalog:check` 都通过。",
    "PR 里只改官方仓库的 `catalog/official.packages.json`，新增 `\"<真实 npm 包名>@<version>\"` 字符串。",
    "不要把本地 `artifacts/catalog/*.json` 当成官方提交文件。",
    "",
    "详细说明：",
    "",
    "- `docs/WORKFLOW.md`",
