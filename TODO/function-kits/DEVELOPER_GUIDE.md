...
1. 本手册：`TODO/function-kits/DEVELOPER_GUIDE.md`
2. Runtime SDK 总览：`TODO/function-kit-runtime-sdk/README.md`
3. 权限与能力清单：`TODO/function-kit-runtime-sdk/docs/CAPABILITIES_AND_PERMISSIONS.md`
4. Bindings 语义（`binding.invoke`）：`TODO/function-kit-runtime-sdk/docs/BINDINGS.md`
5. Host Bridge 协议（想看底层再读）：`TODO/function-kits/host-bridge/README.md`
